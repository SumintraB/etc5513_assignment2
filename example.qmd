...
-   fix the conflict by choose the preferred version and delete (\<\<\<\<\<\<\<, =======, \>\>\>\>\>\>\>)
...
-   add the tag massage "Version 1.0 - merged testbranch and resolved conflict"
...
-   git commit -m "modified example.qmd for step 10"
